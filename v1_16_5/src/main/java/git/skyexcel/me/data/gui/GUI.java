...
public class GUI {
    ...
    public static void listGUI(Player player) {
        ...
        UtilItem.newItem(Data.limitStat, Material.LEGACY_RECORD_12, 1, Arrays.asList(""), 16, inv);
    ...
    public static Inventory upgradeGUI(Player player) {
        ...
        UtilItem.newColoredItem(ChatColor.GRAY + "+ 0.01", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 18, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "+ 0.1", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 19, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "+ 1", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 20, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "+ 10", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 21, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 0.01", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 23, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 0.1", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 24, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 1", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 25, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 10", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 26, inv);
        player.openInventory(inv);
    ...
    public static void limitGUI(Player player) {
        ...
        UtilItem.newColoredItem(ChatColor.GRAY + "100", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 19, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "+10", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 20, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "1", Material.BLUE_STAINED_GLASS, 1, 11, Arrays.asList(""), 21, inv);
        ...
        UtilItem.newColoredItem(ChatColor.GRAY + "- 1", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 23, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 10", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 24, inv);
        UtilItem.newColoredItem(ChatColor.GRAY + "- 100", Material.RED_STAINED_GLASS, 1, 14, Arrays.asList(""), 25, inv);
        player.openInventory(inv);
    }
}
